...
describe('Manage Loan Component Test', () => {
  ...
  it('Apply Loans Component Test', () => {
    const fixture = TestBed.createComponent(ApplyloansComponent);
    const adminhome = fixture.componentInstance;
    expect(adminhome).toBeTruthy();
  });

  it(`should have as title 'Apply Loans Component'`, () => {
    const fixture = TestBed.createComponent(ApplyloansComponent);
    const app = fixture.componentInstance;
    expect(app.title).toEqual('Apply Loans Component');
  });
